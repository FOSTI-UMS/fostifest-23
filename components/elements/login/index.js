    ...
    return (
      <div className="d-flex align-items-center justify-content-center vh-100">
        <div className="text-center">
          <p className="lead">Halaman ini akan dibuka pada tanggal 30 Agustus 2021.</p>
    ...
    >
      <div className="row card container mx-3 d-flex flex-row shadow border border-none p-0" style={{ minHeight: "80vh" }}>
        ...
        >
          ...
          >
            <Lottie animationData={LoginGif} style={{ width: "75%", minHeight: "80vh" }} />
          </div>
        </div>
        <div className="col-lg-6">
          ...
          >
            <div className="card-body">
              <div className="my-5 fs-2 text-center">LOGIN</div>
              <form onSubmit={handleLogin} >
                ...
                <div className="text-white fw-bold text-decoration-none d-flex align-items-center justify-content-center">
                  <button type="submit" className={`mb-3 rounded-5 text-white d-flex align-items-center justify-content-center ${styles["btn-login"]}`} onClick={() => setLoading(true)}>
                    {loading ? <span className="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>: <span>Login</span>}
                  </button>
                </div>
              </form>
              <Link href="/register" className="text-dark fw-bold text-decoration-none mb-5 d-flex align-items-center justify-content-center">
      ...
      {showModal && (
        <div>
          <div className="modal fade show d-block" tabIndex="-1" role="dialog" aria-hidden="true" onClick={closeModal}>
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content">
                <div className="modal-body">
                  <div className="container-fluid">
                    <div className="d-flex justify-content-center">
                      <Lottie animationData={SuccesImage} autoPlay={true} loop={true} className="w-75" />
                    </div>
                    <div className="mb-4 text-center">
                      <h3 className="fw-bold mb-3">Yeayy Selamat !</h3>
                      <small className="text-secondary">Anda Telah Berhasil Mendaftar Silahkan Check Email Anda</small>
                    </div>
                  </div>
                </div>
              </div>
