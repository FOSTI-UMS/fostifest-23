        ...
        <div className="row align-items-center">
          ...
          <div className="col-12 col-md-7 mt-5" data-aos="fade">
            ...
            <div className={`${styles["description-font"]}`}>
              Seminar nasional merupakan Salah satu kegiatan dalam FOSTIFEST 2023 dengan mengusung tema "Creative Exploration in Frontend: Building web design with Bootstrap for the Digital Generation". Menghadirkan pembicara yang ahli dan
              professional untuk meningkatkan kemampuan di bidang IT untuk masyarakat umum. Seminar ini diselenggarakan secara hybrid dengan kouta peserta offline diestimasi sebanyak 100 peserta.
            </div>
            <Link href={"/login"} className="text-decoration-none">
              <div className={`${styles["btn-custom-2"]} mt-3`}>Daftar Seminar</div>
            </Link>
          </div>
        </div>
      </div>
